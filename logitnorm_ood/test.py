...
net.load_state_dict(torch.load('/home/jihwan/DF_synthesis/classifier_pretrained_weights/cifar10_resnet34_9557.pt', map_location=device),strict=False)
start_epoch = 0


# For CIFAR100
# net = ResNet34(num_classes=100).cuda()
# net.load_state_dict(torch.load('/home/jihwan/DF_synthesis/classifier_pretrained_weights/cifar100_resnet34_7802.pth', map_location=device),strict=False)
...
if args.score == 'Odin':
    ...
    in_score = get_ood_gradnorm(args, net, test_loader, ood_num_examples, device, in_dist=True)
else:
...
def get_and_print_results(ood_loader, num_to_avg=args.num_to_avg):
    ...
    for _ in range(num_to_avg):
        ...
        if args.score == 'Odin':
            ...
            out_score = get_ood_gradnorm(args, net, ood_loader, ood_num_examples, device)
        else:
...
if __name__ == '__main__':
    OOD_data_list = [ "CIFAR10-NoT-0.94-ResNet34","CIFAR10-T-0.94-ResNet34"]
