...
from PyHessian_master.pyhessian.utils import group_product, group_add, normalization, get_params_grad, hessian_vector_product, orthnormal
...
class hessian():
    ...
    def __init__(self, model, criterion, data=None, dataloader=None, cuda=True, to_perturb="input"):
        """
        ...
        params, gradsH = get_params_grad(self.model, self.inputs, self.to_pert)
        self.params = params
    ...
    def eigenvalues(self, maxIter=100, tol=1e-3, top_n=1):
        ...
        while computed_dim < top_n:
            ...
            for i in range(maxIter):
                ...
                # self.model.zero_grad() --> would it be problem??
